...
GA::GA() : populationSize(0), genomeLength(0), individualInstance(nullptr)
{}

GA::GA(unsigned int populationSize, unsigned int genomeLength, Attribute* attrInstance, double acceptableError, unsigned int maxGenerations)
...
Individual* GA::findBest()
{
	...
	// add stop if acceptable error is reached
